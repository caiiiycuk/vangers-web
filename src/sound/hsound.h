...
#define SOUND_SHOTGUN(p) 	StartEFFECT(EFF_SHOTGUN, 0, p);
#define SOUND_FLAME(p) 	StartEFFECT(EFF_FLAME, 0, p);
#define SOUND_MINELAYER(p) 	StartEFFECT(EFF_MINELAYER, 0, p);
#define SOUND_SEISMIC(p) 	StartEFFECT(EFF_SEISMIC, 0, p);
#define SOUND_ELECTRIC(p) 	StartEFFECT(EFF_ELECTRIC, 0, p);
