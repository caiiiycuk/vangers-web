...
MessageElement::MessageElement(const char* player_name, char* msg,int col)
{
    ...
    if (strncmp(msg, bot_tag, 5)==0) {
        ...
        actual_msg = msg + 5;
        actual_col = 3;
    } else if ((strcmp(msg, "/start")==0||strcmp(msg, ".�䪥")==0) && is_start==0) {
		name = (char*)"$";
		actual_msg = (char*)"[bot]���� �१ 20 ᥪ㭤";
		if (strcmp(iScrOpt[iSERVER_NAME]->GetValueCHR(), "ohota na mamonta")==0 || strcmp(iScrOpt[iSERVER_NAME]->GetValueCHR(),"mamont")==0) 
			actual_msg = (char*)"[bot]���� ������ �१ 20 ᥪ㭤, ��⭨��� �१ 40";
		actual_col = 3;
		is_start = 1;
	} else if ((strcmp(msg, "/finish")==0||strcmp(msg, ".������")==0) && (is_start==2 || is_start==3)) {
		name = (char*)"$";
		actual_msg = (char*)"�����";
		actual_col = 3;
		is_start = 0;
