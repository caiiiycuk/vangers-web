...
void iGetMultiGameParameters(void)
{
	...
	switch(iCurMultiGame){
		...
		case iMP_MECHOSOMA:
			...
			if(strcmp(game_name,"ohota na mamonta")==0) value = 999999;
			...
			if(strcmp(game_name,"ohota na mamonta")==0) value = 0;
			...
			if(strcmp(game_name,"ohota na mamonta")==0) value = 5;
			...
			if(strcmp(game_name,"skysoma")==0) value = 1;
			if(strcmp(game_name,"ohota na mamonta")==0) value = 1;
			...
			if(strcmp(game_name,"skysoma")==0) value = 1;
			if(strcmp(game_name,"ohota na mamonta")==0) value = 99;
