...
const char* iSTR_WORLD_STADIUM_CHAR = iSTR_WORLD_STADIUM_CHAR1;
...
void iInitStrings(void)
{
	if(lang() == RUSSIAN){
		...
		iSTR_WORLD_STADIUM_CHAR = iSTR_WORLD_STADIUM_CHAR2;
		...
		iSTR_WORLD_STADIUM_CHAR = iSTR_WORLD_STADIUM_CHAR1;
