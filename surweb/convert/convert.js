...
* @returns {Uint8Array}
*/
export function ron2vmp(ron_multi_png, height_png, material_hi_png, material_lo_png) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(ron_multi_png, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ptr1 = passArray8ToWasm0(height_png, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        var ptr2 = passArray8ToWasm0(material_hi_png, wasm.__wbindgen_malloc);
        var len2 = WASM_VECTOR_LEN;
        var ptr3 = passArray8ToWasm0(material_lo_png, wasm.__wbindgen_malloc);
        var len3 = WASM_VECTOR_LEN;
        wasm.ron2vmp(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
...
*/
export function vmp2ron(ini, vmp, vpr, palette) {
    var ptr0 = passStringToWasm0(ini, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passArray8ToWasm0(vmp, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
    var ptr2 = passArray8ToWasm0(vpr, wasm.__wbindgen_malloc);
    var len2 = WASM_VECTOR_LEN;
    var ptr3 = passArray8ToWasm0(palette, wasm.__wbindgen_malloc);
    var len3 = WASM_VECTOR_LEN;
    wasm.vmp2ron(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
}

/**
* @returns {Uint8Array}
*/
export function get_ron_multi_png() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_ron_multi_png(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
* @returns {Uint8Array}
*/
export function get_height_png() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_height_png(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
* @returns {Uint8Array}
*/
export function get_material_hi_png() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_material_hi_png(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
* @returns {Uint8Array}
*/
export function get_material_lo_png() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_material_lo_png(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('convert_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_01770c9cac37dafb = function(arg0, arg1) {
